    ...
    RlineManifest {
        ...
        crates: vec![
            KernelCrateSpec {
                ...
                source_path: "C:\\src\\apportionment\\crates\\rctx-core".to_string(),
                internal_dependencies: vec![],
                migration_status: MigrationStatus::Candidate,
            ...
            KernelCrateSpec {
                ...
                source_path: "C:\\src\\apportionment\\crates\\rstat-core".to_string(),
                internal_dependencies: vec![],
                migration_status: MigrationStatus::Candidate,
            ...
            KernelCrateSpec {
                ...
                source_path: "C:\\src\\apportionment\\crates\\ropt-core".to_string(),
                internal_dependencies: vec![],
                migration_status: MigrationStatus::Candidate,
            ...
            KernelCrateSpec {
                ...
                source_path: "C:\\src\\apportionment\\crates\\rgraph-core".to_string(),
                internal_dependencies: vec![
                    "ropt-core".to_string(),
            ...
            KernelCrateSpec {
                ...
                source_path: "C:\\src\\apportionment\\crates\\rhist-core".to_string(),
        ...
        non_goals: vec![
            ...
            "Do not move RCOUNT CLI or election-audit workflow logic in the foundation pulse.".to_string(),
